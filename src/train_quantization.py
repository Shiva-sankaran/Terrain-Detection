...
from train import evaluate, load_data, train_one_epoch,my_load_data
...
def main(args):
    ...
    dataset, dataset_test, train_sampler, test_sampler = my_load_data(data_dir, args)
...
def get_args_parser(add_help=True):
    ...
    parser.add_argument("--data-path", default="/home/vp.shivasan/gait/data/annotated_data/data", type=str, help="dataset path")
